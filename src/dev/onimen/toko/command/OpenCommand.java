...
public class OpenCommand implements Command {
    ...
    public void execute(List<String> arguments) {
        ...
        var filePath = Paths.get(arguments.get(0));
        try {
            var classReader = new ClassReader(filePath);
            ...
            writer.println(String.format("Class \"%s\" loaded successfully.", filePath.getFileName()));
        } catch (IOException e) {
